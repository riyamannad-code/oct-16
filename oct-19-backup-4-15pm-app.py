...
if "student" in st.session_state:
    ...
    #def build_quiz_prompt(topic, level):
     #   return f"Create a 5-question multiple-choice quiz for Indian students on the topic '{topic}' at a {level.lower()} level. Each question should have 4 options and only one correct answer. Format the output as a list of dictionaries with 'question', 'options', and 'answer' (index of correct option)."
